...
The [Nexmo Conversation Android SDK API Reference docs](https://ea.developer.nexmo.com/sdk/conversation/android/reference/packages.html) are available online. You can also view the docs from within Android Studio. If you do not have access to the docs, please contact [ea-support@nexmo.com](mailto:ea-support@nexmo.com)
